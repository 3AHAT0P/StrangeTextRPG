...
export class NPC3 extends AbstractMerchant {
  protected readonly _id = npc3Info.id;

  protected readonly declensionOfNouns = npc3Info.declensionOfNouns;

  protected readonly _maxHealthPoints = 100;

  public readonly name = npc3Info.name;
