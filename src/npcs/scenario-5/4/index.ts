...
export class NPC4 extends AbstractMerchant {
  protected readonly _id = npc4Info.id;

  protected readonly declensionOfNouns = npc4Info.declensionOfNouns;

  protected readonly _maxHealthPoints = 100;

  public readonly name = npc4Info.name;
