...
export const merchant3Id: `Scenario:${number | string}|Location:${number}|NPC:${number}` = 'Scenario:5|Location:1|NPC:3';

export class Merchant3 extends AbstractMerchant {
  protected readonly _id = merchant3Id;
